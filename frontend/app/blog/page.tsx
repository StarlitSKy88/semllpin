  ...
  return (
    <div className="min-h-screen pt-32 pb-20">
      <div className="container mx-auto px-4">
        <h1 className="text-5xl md:text-7xl font-bold text-center mb-16">SmellPin博客</h1>
        <div className="max-w-3xl mx-auto space-y-12">
          {allPosts.map((post, index) => (
            <div key={index} className="border-b border-white/10 pb-8">
              ...
              >
                阅读全文 <ArrowRight className="transition-transform group-hover:translate-x-1" size={20} />
              </TransitionLink>
            </div>
          ))}
        </div>
